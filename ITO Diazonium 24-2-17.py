...
ax.set_title('Electrografting of Diazonium to ITO')
ax.legend(loc = 'lower right')
ax2.set_title('EIS of ITO Surface Prior to CV')
...
plt.savefig(os.path.join(cv_directory,'ITO_Diaz-24-2-17.png'), dpi=300)
plt.show()