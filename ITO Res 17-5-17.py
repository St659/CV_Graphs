...
directory = '/Users/st659/Google Drive/ITO Resazurin 17-5-17/Resazurin/PB'
directory2 = '/Users/st659/Google Drive/ITO Resazurin 17-5-17/Resazurin/SHU'
...
plt.savefig(os.path.join(directory2,'ResazurinITO_17-5-17.png'), dpi=300)
plt.show()
