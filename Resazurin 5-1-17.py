...
directory = '/Users/st659/Google Drive/Resazurin Growth 5-1-17'
directory2 = '/Users/st659/Google Drive/Resazurin Growth Pseudo 5-1-17'
...
# plt.title('Electrochemical Detection of Bacterial Growth after 5 hours Incubation with 1mM Resazurin')
# plt.ylabel('Current (mA)')
# plt.xlabel('Voltage vs AgAgCl (V)')
# plt.savefig(os.path.join(directory,'ResazurinGrowth_5-1-17.png'), dpi=300)
...
#plt.ylim((-0.06, 0.02))
plt.legend(loc = 'lower right')
plt.title('E.coli MG1655 Pseudo starting at 10^6 CFU/ml after 5 hours Incubation with 1mM Resazurin')
plt.ylabel('Current (mA)')
plt.xlabel('Voltage vs AgAgCl (V)')
plt.savefig(os.path.join(directory2,'ResazurinPseudo_5-1-17.png'), dpi=300)
plt.show()